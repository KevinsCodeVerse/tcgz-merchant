...
module.exports = {
    ...
    publicPath: '/merchant/',
    // 输出文件目录
    // outputDir: "//192.168.0.249/tcgz/merchant",
    outputDir: '../tcgz/merchant',
    ...
    devServer: {
        ...
        proxy: {
            '/api': {
                target: 'https://tcgz.mtfsoft.cn/api/', // 测试
            ...
            '/ws': {
                target: 'https://tcgz.mtfsoft.cn/ws', // 测试
                // target: "https://tcgz.dswang.com/", // 目标代理接口地址
                ws: true, // 是否启用webso ckets 代理
                pathRewrite: {
                    '^/ws': '/'
                }
