...
var routers = [
	...
	{
		path: '/survey/survey',
		component: () => import('@/views/manage/survey/Survey'),
		meta: {
			title: '运营概况'
		}
	},
	{
		path: '/audit/billing',
		component: () => import('@/views/manage/audit/Billing'),
		meta: {
			title: '开单申请审核'
		}
	},
	{
		path: '/score/list',
		component: () => import('@/views/manage/score/ScoreList'),
		meta: {
			title: '积分记录'
		}
	},
	{
		...
		component: () => import('@/views/manage/collective/List'),
		meta: {
			title: '集体列表'
		}
	},
	{
		path: '/user/list',
		component: () => import('@/views/manage/user/UserList'),
		meta: {
			title: '用户列表'
		}
	},
...
router.beforeEach((to, form, next) => {
	...
	var token = sessionStorage.getItem('merchantToken');
