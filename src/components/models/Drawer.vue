<template>
	<el-drawer title="设置选项" :visible.sync="drawer" direction="rtl" :before-close="handleClose" id="tools" size="320px">
		...
		<el-dialog title="修改密码" :visible.sync="dialogVisible" width="30%" @close="closeDialog" append-to-body>
			<el-form label-width="100px">
				<el-form-item label="原密码：">
					<el-input @keyup.enter.native="submit" placeholder="原密码" v-model="formData.oldPassword"></el-input>
				</el-form-item>
				<el-form-item label="新密码：">
					<el-input @keyup.enter.native="submit" placeholder="新密码" v-model="formData.newPassword"></el-input>
				</el-form-item>
				<el-form-item label="确认密码：">
					<el-input @keyup.enter.native="submit" placeholder="确认密码" v-model="againPassword"></el-input>
				</el-form-item>
				<el-form-item label="图片验证码：">
					<el-input @keyup.enter.native="submit" placeholder="图片验证码" v-model="formData.verifyCode"
		...
		<CmpsPass title="忘记密码" :visible.sync="editPassShow" width="550px" append-to-body></CmpsPass>
	</el-drawer>
...
<script>
	...
	import CmpsPass from "./drawer_cmps/CmpsPass.vue"
