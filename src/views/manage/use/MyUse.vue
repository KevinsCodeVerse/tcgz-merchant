<template>
    <div>
                ...
                <div :sm="12" :md="12" :lg="6" :xl="6" :offset="0" v-for="item in list" :key="item.id">
                    <div class="item_box">
                        ...
                        <div class="item_text">
                            ...
                            <div class="btn">
                                <span class="time">有效期至: {{ $common.getDate(item.dueTime) }}</span>
                                <!-- <el-button type="primary" size="mini" class="btn_bt" style="border-right: 5px;" @click="open(item)" >立即续费</el-button> -->
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <use-preview ref="preview_ref" @open="getList()"></use-preview>
    </div>
</template>
