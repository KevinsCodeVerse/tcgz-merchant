<template>
    <div id="arrt">
        ...
        <el-form :inline="true" size="medium">
            <el-form-item>
                <el-input placeholder="请输入用户" style="width: 170px" v-model="screenData.keyWord" />
            </el-form-item>
            <el-form-item>
        ...
        <el-table :data="list" stripe v-loading="loading" style="width: 100%">
            ...
            <el-table-column align="center" prop="title" label="通讯录"></el-table-column>

            <!-- <el-table-column align="center" prop="details" show-overflow-tooltip label="公告内容"></el-table-column> -->

            <el-table-column align="center" prop="status" label="集体类型">
