    ...
    <div class="">
        <div style="display: flex; align-items: center; justify-content: space-between">
            <div style="width: calc(100% - 70px)">
                <el-divider><b style="font-size: 18px">编辑秒杀活动</b> </el-divider>
            </div>
            ...
            <div class="basic basic_info">
                <div>
                    <el-form-item label="商品名">
                        <el-input size="small" v-model="formData.name" class="el-300" maxlength="20"></el-input>
                    </el-form-item>
                ...
                <div>
                    <el-form-item label="商品原价" v-if="formData.isSpec == -1">
                        <el-input type="number" v-model="formData.originalPrice" maxlength="7" class="el-300" size="small" disabled></el-input>
                    </el-form-item>
                    <el-form-item label="商品秒杀价" v-if="formData.isSpec == -1">
                        <el-input
                            type="number"
                            ...
                            maxlength="7"
                            size="small"
                            onInput="value = value<1?1:(value>999999?999999:value)"
                        ></el-input>
                    </el-form-item>
                </div>
                <div>
                    <el-form-item label="商品库存" v-if="formData.isSpec == -1">
                        <el-input
                            ...
                            maxlength="7"
                            size="small"
                            onInput="value = value<1?1:(value>999999?999999:value.replace(/[.]/g,''))"
                        ></el-input>
                    </el-form-item>
                ...
                <div>
                    <el-form-item label="活动时间" v-if="(type == 2 && formData.name) || type == 1">
                        <el-date-picker
                    ...
                    <el-form-item label="单人限购">
                        <el-input
                            ...
                            maxlength="5"
                            size="small"
                            onInput="value = value<1?1:(value>999?999:value.replace(/[.]/g,''))"
                        ></el-input>
                    </el-form-item>
                </div>
            </div>
                ...
                <div v-if="isFreight == 1">
                    <el-form-item label="邮费">
                        <el-input
                            ...
                            size="normal"
                            clearable
                            onInput="value = value<0?1:(value>999999?999999:value)"
                        ></el-input>
                    </el-form-item>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        toSubmit() {
            ...
            if (this.id && this.type == 2) formData.append('id', this.id);
            ...
            formData.append('spikePrice', this.formData.price);
            ...
            this.$request.post({
                url: 'mt/seckill/pro/setSpikePro',
                params: formData,
                success: (res) => {
                    if (this.type == 1) this.$message.success('添加成功');
                    if (this.type == 2) this.$message.success('修改成功');
            ...
            this.$request.post({
                ...
                success: (res) => {
                    if (this.type == 2) {
                        ...
                        this.formData.originalPrice = res.pro.originPrice; // 商品原价
                        this.formData.price = res.pro.spikePrice; // 商品原价
                        this.formData.cover = res.pro.avatar; // 主图
                        this.formData.buyCount = res.pro.buyCount; // 单人限购
                        this.formData.timeArr[0] = common.getDate(res.pro.createTime); // 开始时间
                        this.formData.timeArr[1] = common.getDate(res.pro.endTime); // 结束时间
                        this.formData.firmPrice = res.pro.friendPrice;
                        this.formData.name = res.pro.title; // 标题
                        this.formData.spikePrice = res.pro.spikePrice; // 新价格
                    } else {
                        // 创建 秒杀
                    ...
                    this.formData.id = res.pro.id; // 秒杀id
        ...
        getSku() {
            this.$request.post({
                ...
                params: {
                    proId: this.type == 2 ? this.ProDetail.proId : this.id,
                    type: this.type
                },
                success: (result) => {
                    this.skuList = [];
