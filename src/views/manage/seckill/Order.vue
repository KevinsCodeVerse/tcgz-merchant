<template>
    <div id="">
        ...
        <el-table :data="list" v-loading="loading" stripe fixed="right">
            ...
            <el-table-column label="产品信息" prop="proId" align="center">
                <template slot-scope="scope">
                    ...
                    <p>单价：{{ scope.row.proInfo.price }}</p>
            ...
            <el-table-column label="邮费" align="center">
                <template slot-scope="scope">
                    <span size="mini" v-if="scope.row.freight">￥{{ scope.row.freight }}</span>
            ...
            <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                    ...
                    <el-button size="small" type="success" v-if="scope.row.status == 10" @click="(deliveryData.id = scope.row.id), (deliveryShow = true)">发货</el-button>
                </template>
            </el-table-column>
        </el-table>
            ...
            this.$request.post({
                ...
                success: (result) => {
                    for (var item of result.list) {
                        item.proInfo = JSON.parse(item.proInfo);
                    }
